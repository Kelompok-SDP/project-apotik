            ...
            <div class="col-8">
                    <form  @submit.prevent="addData()">
                        ...
                        <div id="lanjutan" style="display:none">
                            ...
                            <div class="form-group">
                                <label for="">Masukkan Password baru (jika tidak ingin mengganti dikosongi saja)</label>
                                <input
                                    type="password"
                                    class="form-control"
                                    id=""
                            ...
                            <div class="form-group">
                                <label for="">Masukkan Confirm Password baru (jika tidak ingin mengganti dikosongi saja)</label>
                                <input
                                    type="password"
                                    class="form-control"
                                    id=""
                    ...
                    <button class="btn btn-md btn-primary" id="btnEdit"  @click="editData()">Edit Your Profile</button>
            </div>
            <div class="col-4">
...
export default {
  ...
  methods: {
    ...
    addData(){
        ...
        .post("/profilUser/update",formData)
        .then((result) => {
