  ...
  <div>
    ...
    <div class="container">
        <div class="mt-5">
            ...
            <h3>{{ artikel.title }}</h3>
            <br>
            <h5 style="font-style: italic; color: gray; font-size: 15px;">Dibuat pada: {{ tanggal }}</h5>
            <img
            ...
            height="600px"
            />
            <div style="font-size: 20px"><p><span style="color: red;">UChicago Medicine</span>  - {{ artikel.content }}</p></div>
            </div>
        </div>
    </div>
    <Footer />
...
export default {
  ...
  methods: {
    loadContent() {
      axios
        .get("/artikel/"+ this.$route.params.slug)
        .then((result) => {
